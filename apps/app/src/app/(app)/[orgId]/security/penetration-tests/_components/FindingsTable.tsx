...
export function FindingsTable({
  ...
  return (
    <div className={cn('overflow-hidden rounded-[var(--radius)] border border-border', className)}>
          ...
          {sorted.map((issue) => (
            <tr
              ...
              className={cn(
                ...
                onRowClick && 'cursor-pointer outline-none hover:bg-muted focus-visible:bg-muted',
            ...
            >
              ...
              <td className="px-3 py-2.5 align-middle">
                ...
                {issue.cweId ? (
                  <div className="font-mono text-[10px] text-muted-foreground">{issue.cweId}</div>
                ) : null}
              </td>
