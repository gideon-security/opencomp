...
describe('requirements table layout', () => {
  it('defines a compact column for every visible requirement field', () => {
    ...
    expect(
      screen.getByRole('columnheader', { name: 'controlsTable.columnIdentifier' }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole('columnheader', { name: 'controlsTable.columnDescription' }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole('columnheader', { name: 'controlsTable.columnControls' }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole('columnheader', { name: 'controlsTable.columnCompliance' }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole('columnheader', { name: 'controlsTable.columnStatus' }),
    ).toBeInTheDocument();
