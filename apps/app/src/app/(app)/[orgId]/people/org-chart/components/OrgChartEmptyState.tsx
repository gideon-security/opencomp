...
export function OrgChartEmptyState({ members, onChartChange }: OrgChartEmptyStateProps) {
  ...
  if (mode === 'upload') {
    return <UploadOrgChartDialog onClose={() => setMode('empty')} onUploaded={onChartChange} />;
  }
