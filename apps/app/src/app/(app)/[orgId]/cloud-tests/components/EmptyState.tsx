...
const CLOUD_PROVIDERS = [
  {
    ...
    guideUrl: 'https://gideondefender.com/docs/cloud-tests/aws',
  },
  {
    id: 'gcp' as const,
    ...
    guideUrl: 'https://gideondefender.com/docs/cloud-tests/gcp',
  },
  {
    id: 'azure' as const,
    ...
    guideUrl: 'https://gideondefender.com/docs/cloud-tests/azure',
  },
];
