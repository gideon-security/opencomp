...
export const BrowserAuthProfileStatus = {
...
export const BrowserAutomationFailureCode = {
  needs_reauth: 'needs_reauth',
...
export const BrowserAutomationFailureStage = {
  auth: 'auth',
...
export const FrameworkEditorFrameworkFamilyStatus = {
  visible: 'visible',
  hidden: 'hidden',
...
export const IsmsAuditConclusionVerdict = {
  conform: 'conform',
  substantially_conform: 'substantially_conform',
  not_yet_conform: 'not_yet_conform',
} as const;
export const IsmsAuditControlResult = {
  conformity_confirmed: 'conformity_confirmed',
  nonconformity_raised: 'nonconformity_raised',
  observation_raised: 'observation_raised',
  not_sampled: 'not_sampled',
} as const;
export const IsmsAuditFindingStatus = {
  open: 'open',
  in_progress: 'in_progress',
  closed: 'closed',
} as const;
export const IsmsAuditFindingType = {
  nc_major: 'nc_major',
  nc_minor: 'nc_minor',
  ofi: 'ofi',
  observation: 'observation',
} as const;
export const IsmsAuditRoute = {
  in_house: 'in_house',
  external: 'external',
  training_planned: 'training_planned',
} as const;
export const IsmsAuditStatus = {
  planned: 'planned',
  in_progress: 'in_progress',
  complete: 'complete',
} as const;
export const IsmsCompetenceBasis = {
  education: 'education',
  training: 'training',
  experience: 'experience',
  combination: 'combination',
} as const;
export const IsmsContextIssueKind = {
  internal: 'internal',
  external: 'external',
} as const;
export const IsmsContextSource = {
  derived: 'derived',
  manual: 'manual',
} as const;
export const IsmsDocumentStatus = {
  draft: 'draft',
  in_progress: 'in_progress',
...
export const IsmsDocumentType = {
  context_of_organization: 'context_of_organization',
  interested_parties_register: 'interested_parties_register',
  interested_parties_requirements: 'interested_parties_requirements',
  ...
  objectives_plan: 'objectives_plan',
  monitoring: 'monitoring',
  internal_audit: 'internal_audit',
  management_review: 'management_review',
} as const;
export const IsmsMetricCadence = {
  monthly: 'monthly',
  quarterly: 'quarterly',
} as const;
export const IsmsObjectiveStatus = {
  not_started: 'not_started',
  on_track: 'on_track',
  at_risk: 'at_risk',
  met: 'met',
} as const;
export const IsmsReviewActionStatus = {
  open: 'open',
  in_progress: 'in_progress',
  closed: 'closed',
} as const;
export const IsmsReviewConclusionVerdict = {
  suitable: 'suitable',
  adequate: 'adequate',
  effective: 'effective',
} as const;
export const IsmsReviewStatus = {
  planned: 'planned',
  in_progress: 'in_progress',
  complete: 'complete',
} as const;
