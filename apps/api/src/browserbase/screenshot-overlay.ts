...
// OpenComp hex logo mark, viewBox 0 0 56 56. Fill is overridden at render time.
...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  ...
  <g font-family='${fontFamily}' fill="${OVERLAY_TEXT}">
    <text x="${brandTextX}" y="${brandTextY}" font-size="13" font-weight="700" letter-spacing="-0.2">OpenComp</text>
