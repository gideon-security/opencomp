...
/**
 * Strip the query string before logging a Checkr path. Candidate search
 * carries the employee email in `?email=`, which must never reach logs.
 */
export function redactPathForLog(path: string): string {
