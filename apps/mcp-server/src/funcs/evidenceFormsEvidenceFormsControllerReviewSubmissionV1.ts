...
> {
  const parsed$ = safeParse(
    request,
    (value$) => EvidenceFormsControllerReviewSubmissionV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/evidence-forms/{formType}/submissions/{submissionId}/review')(
    pathParams$,
  );
