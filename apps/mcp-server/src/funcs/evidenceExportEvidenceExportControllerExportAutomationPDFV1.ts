...
> {
  const parsed$ = safeParse(
    request,
    (value$) => EvidenceExportControllerExportAutomationPdfv1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/tasks/{taskId}/evidence/automation/{automationId}/pdf')(
    pathParams$,
  );
