...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CloudSecurityControllerMarkFindingAsExceptionV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/cloud-security/findings/{findingId}/exception')(pathParams$);
