...
> {
  const parsed$ = safeParse(
    request,
    (value$) => AutomationsControllerGetAutomationVersionsV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/tasks/{taskId}/automations/{automationId}/versions')(pathParams$);
