...
> {
  const parsed$ = safeParse(
    request,
    (value$) => TrustAccessControllerGetPublicCustomFrameworksV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/trust-access/{friendlyUrl}/custom-frameworks')(pathParams$);
