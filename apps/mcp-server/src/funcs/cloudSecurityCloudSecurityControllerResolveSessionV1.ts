...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CloudSecurityControllerResolveSessionV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/cloud-security/resolve-session/{connectionId}')(pathParams$);
