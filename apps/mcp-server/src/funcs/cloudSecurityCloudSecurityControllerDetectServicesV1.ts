...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CloudSecurityControllerDetectServicesV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/cloud-security/detect-services/{connectionId}')(pathParams$);
