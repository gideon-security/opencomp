...
> {
  const parsed$ = safeParse(
    request,
    (value$) => OffboardingChecklistControllerUpdateTemplateItemV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/offboarding-checklist/template/{id}')(pathParams$);
