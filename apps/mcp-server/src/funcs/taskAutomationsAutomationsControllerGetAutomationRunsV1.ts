...
> {
  const parsed$ = safeParse(
    request,
    (value$) => AutomationsControllerGetAutomationRunsV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/tasks/{taskId}/automations/{automationId}/runs')(pathParams$);
