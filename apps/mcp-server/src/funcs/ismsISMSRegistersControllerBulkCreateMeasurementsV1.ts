...
> {
  const parsed$ = safeParse(
    request,
    (value$) => IsmsRegistersControllerBulkCreateMeasurementsV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/isms/documents/{id}/measurements/bulk')(pathParams$);
