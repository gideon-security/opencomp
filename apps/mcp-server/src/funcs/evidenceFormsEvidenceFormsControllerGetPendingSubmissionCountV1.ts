...
export function evidenceFormsEvidenceFormsControllerGetPendingSubmissionCountV1(
  client$: CompAiCore,
  request?: EvidenceFormsControllerGetPendingSubmissionCountV1Request | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      EvidenceFormsControllerGetPendingSubmissionCountV1Request$zodSchema.optional().parse(value$),
