...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ChecksControllerRunConnectionChecksV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/integrations/checks/connections/{connectionId}/run')(pathParams$);
