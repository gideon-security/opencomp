...
> {
  const parsed$ = safeParse(
    request,
    (value$) => QuestionnaireControllerAutoAnswerAndExportUploadV1Request$zodSchema.parse(value$),
  ...
  if (isBlobLike(payload$.file)) {
    ...
    const contentType =
      getContentTypeFromFileName(payload$.file.fileName) || 'application/octet-stream';
