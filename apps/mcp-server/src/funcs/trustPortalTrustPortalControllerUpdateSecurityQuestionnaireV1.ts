...
> {
  const parsed$ = safeParse(
    request,
    (value$) => TrustPortalControllerUpdateSecurityQuestionnaireV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/trust-portal/settings/security-questionnaire')();
