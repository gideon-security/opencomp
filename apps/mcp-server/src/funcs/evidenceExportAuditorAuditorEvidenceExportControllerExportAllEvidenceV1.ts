...
export function evidenceExportAuditorAuditorEvidenceExportControllerExportAllEvidenceV1(
  client$: CompAiCore,
  request?: AuditorEvidenceExportControllerExportAllEvidenceV1Request | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      AuditorEvidenceExportControllerExportAllEvidenceV1Request$zodSchema.optional().parse(value$),
