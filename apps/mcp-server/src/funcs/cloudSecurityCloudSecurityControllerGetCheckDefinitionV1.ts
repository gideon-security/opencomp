...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CloudSecurityControllerGetCheckDefinitionV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/cloud-security/findings/{findingId}/check-definition')(pathParams$);
