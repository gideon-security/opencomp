...
> {
  const parsed$ = safeParse(
    request,
    (value$) => KnowledgeBaseControllerGetDownloadUrlV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/knowledge-base/documents/{documentId}/download')(pathParams$);
