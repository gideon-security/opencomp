...
> {
  const parsed$ = safeParse(
    request,
    (value$) => VariablesControllerSaveConnectionVariablesV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/integrations/variables/connections/{connectionId}')(pathParams$);
