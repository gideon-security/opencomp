...
> {
  const parsed$ = safeParse(
    request,
    (value$) => TrustPortalControllerDeleteTrustDocumentV1Request$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc('/v1/trust-portal/documents/{documentId}/delete')(pathParams$);
