...
export function landingPageHTML(origin: string): string {
  ...
  const mcpConfig = {
    command: 'npx',
    args: ['-y', 'mcp-remote@0.1.25', `${o}/sse`, '--header', 'apikey:${APIKEY}'],
      ...
      <div class="content-container">
        ...
        <section class="raw-configuration container">
          ...
          <div class="code-container card">
            ...
            <code class="code-snippet language-json" id="raw-config">${JSON.stringify(
              mcpConfig,
              null,
              2,
            )}</code>
    ...
    <div class="modal" id="claude-desktop-modal">
      ...
      <div class="content-slot">
        ...
        <div class="instruction-item">
          <a href="https://github.com/gideon-security/opencomp/releases/download/v0.2.5/mcp-server.mcpb" download="mcp-server.mcpb" class="action-button header-action" style="display: inline-flex; margin-bottom: 16px;">
            📥 Download MCP Bundle
          </a>
        </div>
