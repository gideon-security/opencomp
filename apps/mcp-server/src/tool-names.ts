...
export const toolNames: Array<{ name: string; description: string }>= [
  ...
  },
  {
    ...
    "description": "List integration connections\n\nList integration connections in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
  ...
  },
  {
    ...
    "description": "Update an integration connection\n\nUpdate an integration connection in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
  ...
  },
  {
    ...
    "description": "Pause an integration connection\n\nPause an integration connection in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
    "name": "resume-connection",
    "description": "Resume an integration connection\n\nResume an integration connection in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
  ...
  },
  {
    ...
    "description": "List check definitions for a provider\n\nList check definitions for a provider in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
  ...
  },
  {
    ...
    "description": "Run a single check on a connection\n\nRun a single check on a connection in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
  ...
  },
  {
    ...
    "description": "Get options for a connection variable\n\nGet options for a connection variable in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
  ...
  },
  {
    ...
    "description": "Run a check for a task\n\nRun a check for a task in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
    "name": "disconnect-check-from-task",
    "description": "Disconnect checks from a task\n\nDisconnect checks from a task in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
  ...
  },
  {
    ...
    "description": "Sync JumpCloud employees\n\nSync JumpCloud employees in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
  ...
  },
  {
    ...
    "description": "Get the currently configured employee sync provider\n\nGet the currently configured employee sync provider in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
  ...
  },
  {
    ...
    "description": "Set the device sync provider\n\nSet the device sync provider in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
  ...
  },
  {
    ...
    "description": "Sync employees for a dynamic provider\n\nSync employees for a dynamic provider in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
    "name": "sync-dynamic-provider-devices",
    "description": "Sync devices for a dynamic provider\n\nSync devices for a dynamic provider in OpenComp. Connect vendor systems, configure OAuth apps, run compliance checks, sync employees, manage variables, and collect automated evidence."
  },
  {
  ...
  {
    "name": "get-history",
    "description": "List resolution, exception, and regression history for a connection\n\nList resolution, exception, and regression history for a connection in OpenComp. Run AWS, Azure, and GCP cloud security scans, detect enabled services, review findings, and connect cloud posture results to compliance work."
  },
  {
  ...
  {
    "name": "detect-gcp-org",
    "description": "Detect the GCP organization for a connection\n\nDetect the GCP organization for a connection in OpenComp. Run AWS, Azure, and GCP cloud security scans, detect enabled services, review findings, and connect cloud posture results to compliance work."
  },
  {
    "name": "select-gcp-projects",
    "description": "Select GCP projects for a connection\n\nSelect GCP projects for a connection in OpenComp. Run AWS, Azure, and GCP cloud security scans, detect enabled services, review findings, and connect cloud posture results to compliance work."
  },
  {
    "name": "setup-gcp",
  ...
  },
  {
    ...
    "description": "Resolve a GCP setup step\n\nResolve a GCP setup step in OpenComp. Run AWS, Azure, and GCP cloud security scans, detect enabled services, review findings, and connect cloud posture results to compliance work."
  },
  {
    "name": "setup-azure",
    "description": "Set up Azure for a connection\n\nSet up Azure for a connection in OpenComp. Run AWS, Azure, and GCP cloud security scans, detect enabled services, review findings, and connect cloud posture results to compliance work."
  },
  {
    "name": "validate-azure",
    "description": "Validate Azure credentials for a connection\n\nValidate Azure credentials for a connection in OpenComp. Run AWS, Azure, and GCP cloud security scans, detect enabled services, review findings, and connect cloud posture results to compliance work."
  },
  {
    "name": "trigger-scan",
  ...
  },
  {
    ...
    "description": "Get mapped and all controls for a policy\n\nGet mapped and all controls for a policy in OpenComp. Create, version, publish, export, map, and improve compliance policies with AI-assisted drafting and approval workflows."
  },
  {
  ...
  },
  {
    ...
    "description": "Get policy version by ID\n\nGet policy version by ID in OpenComp. Create, version, publish, export, map, and improve compliance policies with AI-assisted drafting and approval workflows."
  },
  {
  ...
  {
    "name": "delete-task",
    "description": "Delete a task\n\nDelete a task in OpenComp. Manage compliance task lifecycle, assignments, review approvals, evidence uploads, policy links, and activity history."
  },
  {
  ...
  },
  {
    ...
    "description": "Get all automations for a task\n\nGet all automations for a task in OpenComp. Create, version, run, and inspect automated evidence collection workflows attached to compliance tasks."
  },
  {
    "name": "get-automation",
    "description": "Get automation details\n\nGet automation details in OpenComp. Create, version, run, and inspect automated evidence collection workflows attached to compliance tasks."
  },
  {
  ...
  },
  {
    ...
    "description": "Get all automation runs for a task\n\nGet all automation runs for a task in OpenComp. Create, version, run, and inspect automated evidence collection workflows attached to compliance tasks."
  },
  {
  ...
  {
    "name": "remove-favicon",
    "description": "Remove the trust portal favicon\n\nRemove the trust portal favicon in OpenComp. Configure the live Trust Center, custom domain, public overview, FAQs, compliance resources, documents, links, and vendor disclosures."
  },
  {
  ...
  {
    "name": "toggle-portal",
    "description": "Enable or disable the trust portal\n\nEnable or disable the trust portal in OpenComp. Configure the live Trust Center, custom domain, public overview, FAQs, compliance resources, documents, links, and vendor disclosures."
  },
  {
  ...
  {
    "name": "update-role",
    "description": "Update a custom role\n\nUpdate a custom role in OpenComp. Create custom roles and resolve permission sets for organization-level access control."
  },
  {
    "name": "delete-role",
  ...
  },
  {
    ...
    "description": "Get a signed download URL for a document\n\nGet a signed download URL for a document in OpenComp. Upload source documents, process them for retrieval, and manage reusable manual answers that power questionnaires and AI policy workflows."
  },
  {
    "name": "get-view-url",
  ...
  {
    "name": "get-task-items",
    "description": "Get task items for an entity\n\nGet task items for an entity in OpenComp. Manage task items and attachments linked to operational entities such as risks and vendors."
  },
  {
  ...
  },
  {
    ...
    "description": "Delete attachment from task item\n\nDelete attachment from task item in OpenComp. Manage task items and attachments linked to operational entities such as risks and vendors."
  },
  {
  ...
  {
    "name": "get-progress",
    "description": "Get penetration test progress\n\nGet penetration test progress in OpenComp. Create AI-powered penetration test runs, track progress, inspect findings and events, and download markdown or PDF reports."
  },
  {
    "name": "get-issues",
