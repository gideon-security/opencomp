...
export const tool$organizationOrganizationControllerUploadLogoV1: ToolDefinition = {
  name: 'upload-logo',
...
Upload organization logo in OpenComp. Manage organization profile data, API keys, logos, ownership, role notifications, and access approval settings.`,
  ...
  tool: async (client, ctx) => {
    const [result] = await organizationOrganizationControllerUploadLogoV1(client, {
