...
export const tool$trustPortalTrustPortalControllerUpdateFaqsV1: ToolDefinition<typeof args> = {
  name: 'update-faqs',
...
Update trust portal FAQs in OpenComp. Configure the live Trust Center, custom domain, public overview, FAQs, compliance resources, documents, links, and vendor disclosures.`,
  ...
  tool: async (client, args, ctx) => {
    const [result] = await trustPortalTrustPortalControllerUpdateFaqsV1(client, args.request, {
