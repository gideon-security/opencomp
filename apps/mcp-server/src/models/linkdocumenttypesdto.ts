...
export const LinkDocumentTypesDto$zodSchema: z.ZodType<LinkDocumentTypesDto> = z.object({
  formTypes: z
    .array(FormType$zodSchema)
    .describe('Evidence form types to require for this control'),
});
