...
export const SetEmployeeSyncProviderDtoProvider$zodSchema: z.ZodType<SetEmployeeSyncProviderDtoProvider> =
  z
    .object({})
    .describe(
      'Provider slug to use for employee sync (must have the "sync" capability in its manifest — call list-providers to see options). Pass null or omit the field to disable employee sync for this org.',
...
export const SetEmployeeSyncProviderDto$zodSchema: z.ZodType<SetEmployeeSyncProviderDto> = z.object(
  {
    organizationId: z
      .string()
      .optional()
    ...
    provider: z
      .lazy(() => SetEmployeeSyncProviderDtoProvider$zodSchema)
      .nullable()
      .optional()
      .describe(
        'Provider slug to use for employee sync (must have the "sync" capability in its manifest — call list-providers to see options). Pass null or omit the field to disable employee sync for this org.',
