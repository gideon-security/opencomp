...
export const ControlsControllerUnlinkDocumentTypeV1FormType$zodSchema = z
  .enum([
    'board_meeting',
...
export const ControlsControllerUnlinkDocumentTypeV1Security$zodSchema: z.ZodType<ControlsControllerUnlinkDocumentTypeV1Security> =
  z.object({
...
export const ControlsControllerUnlinkDocumentTypeV1Request$zodSchema: z.ZodType<ControlsControllerUnlinkDocumentTypeV1Request> =
  z.object({
