...
export const SetTwoFactorSourceDtoProvider$zodSchema: z.ZodType<SetTwoFactorSourceDtoProvider> = z
  .object({})
  .describe(
    'Provider slug whose 2FA check feeds the People-tab 2FA column (must be bound to the 2FA task — call available-2fa-sources for options). Pass null or omit to clear the source.',
  );
...
export const SetTwoFactorSourceDto$zodSchema: z.ZodType<SetTwoFactorSourceDto> = z.object({
  organizationId: z
    .string()
    .optional()
    .describe(
  ...
  provider: z
    .lazy(() => SetTwoFactorSourceDtoProvider$zodSchema)
    .nullable()
    .optional()
    .describe(
      'Provider slug whose 2FA check feeds the People-tab 2FA column (must be bound to the 2FA task — call available-2fa-sources for options). Pass null or omit to clear the source.',
