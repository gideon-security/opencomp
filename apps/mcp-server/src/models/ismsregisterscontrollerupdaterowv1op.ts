...
export const IsmsRegistersControllerUpdateRowV1Kind$zodSchema = z.enum(['internal', 'external']);
...
export const IsmsRegistersControllerUpdateRowV1BasisOfCompetence$zodSchema = z.enum([
  'education',
  'training',
  'experience',
  'combination',
...
export const IsmsRegistersControllerUpdateRowV1ConclusionVerdict$zodSchema = z.enum([
  'conform',
...
export type IsmsRegistersControllerUpdateRowV1RequestBody = {
  ...
  basisOfCompetence?: IsmsRegistersControllerUpdateRowV1BasisOfCompetence | null | undefined;
  ...
  conclusionVerdict?: IsmsRegistersControllerUpdateRowV1ConclusionVerdict | null | undefined;
...
export const IsmsRegistersControllerUpdateRowV1RequestBody$zodSchema: z.ZodType<IsmsRegistersControllerUpdateRowV1RequestBody> =
  z
    .object({
      ...
      auditRoute: IsmsRegistersControllerUpdateRowV1AuditRoute$zodSchema.nullable().optional(),
      ...
      basisOfCompetence:
        IsmsRegistersControllerUpdateRowV1BasisOfCompetence$zodSchema.nullable().optional(),
      ...
      conclusionVerdict:
        IsmsRegistersControllerUpdateRowV1ConclusionVerdict$zodSchema.nullable().optional(),
      ...
      result: IsmsRegistersControllerUpdateRowV1Result$zodSchema.nullable().optional(),
...
export const IsmsRegistersControllerUpdateRowV1Request$zodSchema: z.ZodType<IsmsRegistersControllerUpdateRowV1Request> =
  z.object({
    body: z
      .lazy(() => IsmsRegistersControllerUpdateRowV1RequestBody$zodSchema)
      .describe('Register row fields (per-register; validated at runtime by zod)'),
    register: z.string(),
    rowId: z.string(),
  });
