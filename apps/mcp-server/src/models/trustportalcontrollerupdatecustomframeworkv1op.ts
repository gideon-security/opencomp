...
export const TrustPortalControllerUpdateCustomFrameworkV1Status2$zodSchema = z.enum([
  'started',
  'in_progress',
  'compliant',
]);
...
export const TrustPortalControllerUpdateCustomFrameworkV1Status1$zodSchema = z.enum([
  'started',
  'in_progress',
  'compliant',
]);
...
export const TrustPortalControllerUpdateCustomFrameworkV1RequestBody2$zodSchema: z.ZodType<TrustPortalControllerUpdateCustomFrameworkV1RequestBody2> =
  z.object({
...
export const TrustPortalControllerUpdateCustomFrameworkV1RequestBody1$zodSchema: z.ZodType<TrustPortalControllerUpdateCustomFrameworkV1RequestBody1> =
  z.object({
    customFrameworkId: z.string(),
    enabled: z.boolean(),
    status: TrustPortalControllerUpdateCustomFrameworkV1Status1$zodSchema.optional(),
  });
...
export const TrustPortalControllerUpdateCustomFrameworkV1Request$zodSchema: z.ZodType<TrustPortalControllerUpdateCustomFrameworkV1Request> =
  z
    .union([
      z.lazy(() => TrustPortalControllerUpdateCustomFrameworkV1RequestBody1$zodSchema),
      z.lazy(() => TrustPortalControllerUpdateCustomFrameworkV1RequestBody2$zodSchema),
    ])
