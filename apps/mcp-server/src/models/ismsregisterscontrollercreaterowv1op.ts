...
export const IsmsRegistersControllerCreateRowV1Kind$zodSchema = z.enum(['internal', 'external']);
...
export const IsmsRegistersControllerCreateRowV1BasisOfCompetence$zodSchema = z.enum([
  'education',
  'training',
  'experience',
  'combination',
...
export const IsmsRegistersControllerCreateRowV1ConclusionVerdict$zodSchema = z.enum([
  'conform',
...
export type IsmsRegistersControllerCreateRowV1RequestBody = {
  ...
  basisOfCompetence?: IsmsRegistersControllerCreateRowV1BasisOfCompetence | null | undefined;
  ...
  conclusionVerdict?: IsmsRegistersControllerCreateRowV1ConclusionVerdict | null | undefined;
...
export const IsmsRegistersControllerCreateRowV1RequestBody$zodSchema: z.ZodType<IsmsRegistersControllerCreateRowV1RequestBody> =
  z
    .object({
      ...
      auditRoute: IsmsRegistersControllerCreateRowV1AuditRoute$zodSchema.nullable().optional(),
      ...
      basisOfCompetence:
        IsmsRegistersControllerCreateRowV1BasisOfCompetence$zodSchema.nullable().optional(),
      ...
      conclusionVerdict:
        IsmsRegistersControllerCreateRowV1ConclusionVerdict$zodSchema.nullable().optional(),
      ...
      periodStart: z
        .string()
        .optional()
        .describe('First day of the covered period (YYYY-MM-DD), aligned to the metric cadence'),
      ...
      result: IsmsRegistersControllerCreateRowV1Result$zodSchema.nullable().optional(),
...
export const IsmsRegistersControllerCreateRowV1Request$zodSchema: z.ZodType<IsmsRegistersControllerCreateRowV1Request> =
  z.object({
    body: z
      .lazy(() => IsmsRegistersControllerCreateRowV1RequestBody$zodSchema)
      .describe('Register row fields (per-register; validated at runtime by zod)'),
    id: z.string(),
    register: z.string(),
  });
