...
export const manifest: IntegrationManifest = {
  ...
  docsUrl: 'https://docs.gideondefender.com/integrations/aikido',
  ...
  services: [
    {
      ...
      description: 'Code repository and dependency vulnerability scanning',
    ...
    },
    {
      id: 'issue-tracking',
      name: 'Issue Tracking',
      description: 'Security issue count thresholds and tracking',
      enabledByDefault: true,
      implemented: true,
    },
    {
