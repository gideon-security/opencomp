...
const config: {
  ...
  guide_url: 'https://gideondefender.com/docs/cloud-tests/azure',
  description:
    'OpenComp can automatically collect evidence from your Microsoft Azure account to show your cloud infrastructure is compliant with different compliance frameworks.',
  images: [],
  settings: [
    {
      id: 'AZURE_CLIENT_ID',
