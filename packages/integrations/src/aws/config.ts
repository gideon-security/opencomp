...
const config: {
  ...
  guide_url: 'https://gideondefender.com/docs/cloud-tests/aws',
  description:
    'OpenComp can automatically collect evidence from your AWS account to show your cloud infrastructure is compliant with different compliance frameworks.',
  images: [],
  settings: [
    {
      id: 'region',
