...
const config: {
  ...
  guide_url: 'https://gideondefender.com/docs/cloud-tests/gcp',
  description:
    'OpenComp can automatically collect evidence from your Google Cloud Platform account to show your cloud infrastructure is compliant with different compliance frameworks.',
  images: [],
  settings: [
    {
      id: 'organization_id',
