...
export const DEFAULT_PORTAL_URL =
  typeof __PORTAL_URL__ !== 'undefined' ? __PORTAL_URL__ : 'https://app.staging.gideondefender.com';

/** Default API base URL - injected at build time via electron-vite define */
export const DEFAULT_API_URL =
  typeof __API_URL__ !== 'undefined' ? __API_URL__ : 'https://api.staging.gideondefender.com';
