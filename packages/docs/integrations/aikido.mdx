...
description: "Connect Aikido to automate security evidence in OpenComp"
---

## Overview

The Aikido Security integration syncs vulnerability and repository scanning data into OpenComp, so compliance tasks can be automatically satisfied with continuous evidence.

## What OpenComp Collects
...
1. Open the Aikido integration in OpenComp
