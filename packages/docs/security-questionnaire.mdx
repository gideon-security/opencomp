...
description: 'Automatically answer vendor security questionnaires with approved policies, knowledge base documents, and OpenComp review workflows.'
---
...
1. Check our [Knowledge Base](https://help.gideondefender.com/security-questionnaire)
